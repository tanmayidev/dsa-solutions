...
/**
Take Longest Common Subsequence + add the remaining characters which are not common in both strings
- The above may not make sure the sequence persists

so, N + M - LCS

That will make it the shortest supersequence
*/
